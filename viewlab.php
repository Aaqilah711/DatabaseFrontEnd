...
<head>
    ...
    <style>
        ...
        .highlighted-row {
            background-color: #ffff99; /* Change the background color to highlight */
        }
    </style>
</head>
<body>
    ...
    <div class="a">
        ...
        <div class="search-container">
            ...
            <input type="text" id="search" name="search" placeholder="Enter VSR Plasmid no">
        </div>
        <div class="cont">
            <button class="form-container-btn" type="submit" name="submit" id="'submit">Search</button>
        </div>
        </form>
    </div>
